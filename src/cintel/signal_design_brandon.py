...
Paths (relative to repo root)
    ...
    OUTPUT FILE: artifacts/signals_brandon.csv
...
def main() -> None:
    ...
    # ----------------------------------------------------
    # Only calculate per-request signals when requests < 5.
    # Use the Polars col() function to refer to a column by name.
    # This creates a boolean expression:
    # True when requests < 5, False otherwise.
    is_requests_positive: pl.Expr = pl.col("requests") < 120
